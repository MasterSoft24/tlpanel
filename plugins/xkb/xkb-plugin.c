...
static GtkWidget *xkb_configure(LXPanel *panel, GtkWidget *p)
{
    ...
    GtkWidget * p_hbox_main = gtk_box_new(GTK_ORIENTATION_HORIZONTAL, 0); // fix by MS
    //GtkWidget * p_vbox_left = gtk_vbox_new(FALSE, 0);
    GtkWidget * p_vbox_left = gtk_box_new(GTK_ORIENTATION_VERTICAL, 0); // fix by MS
    //GtkWidget * p_vbox_right = gtk_vbox_new(FALSE, 0);
    GtkWidget * p_vbox_right = gtk_box_new(GTK_ORIENTATION_VERTICAL, 0); // fix by MS
    ...
    GtkWidget * p_hbox_kbd_layouts = gtk_box_new(GTK_ORIENTATION_HORIZONTAL, 0); // fix by MS
    ...
    GtkWidget *p_hbox_flag_size = gtk_box_new(GTK_ORIENTATION_HORIZONTAL, 2); // fix by MS
